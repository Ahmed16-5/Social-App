...
export default function Navbar() {
  ...
  // غلق dropdown تلقائي بعد login/logout
  useEffect(() => {
        ...
        <div className="flex gap-4 items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          {userLogin ? (
            <>
              ...
              {/* Dropdown */}
              <div
                className={`absolute right-0 mt-2 w-48 bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600 z-50 ${
